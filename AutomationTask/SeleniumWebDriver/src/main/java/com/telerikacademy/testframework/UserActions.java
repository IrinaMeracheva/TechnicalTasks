...
public class UserActions {
    ...
    public void assertTextElement(String locator, String str) {
        WebElement element = driver.findElement(By.xpath(Utils.getUIMappingByKey(locator)));
        String text = element.getText();
        Assert.assertEquals(format("Element with locator %s doesn't match", element), text, getUIMappingByKey(str));
    }

    public void selectFromDropdownByText(String name, String text) {
        Select dropdownSelect = new Select(driver.findElement(By.name(name)));
